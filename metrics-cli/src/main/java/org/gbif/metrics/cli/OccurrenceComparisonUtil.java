...
public class OccurrenceComparisonUtil {
  ...
  public static boolean equivalent(Occurrence occ1, Occurrence occ2) {
    return Objects.equal(occ1.getKey(), occ2.getKey())
      ...
      && Objects.equal(occ1.getOwningOrgKey(), occ2.getOwningOrgKey())
      ...
      && Objects.equal(occ1.getGeospatialIssue(), occ2.getGeospatialIssue())
      ...
      && Objects.equal(occ1.getHostCountry(), occ2.getHostCountry())
