...
java -cp $HADOOP_HOME/hadoop-hdfs/hadoop-hdfs-2.6.0-cdh5.4.2.jar:../../conf:../../../target/cube-0.23-SNAPSHOT-for-backfills.jar org.gbif.metrics.cube.index.taxon.backfill.Backfill
